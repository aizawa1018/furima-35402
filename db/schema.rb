...
ActiveRecord::Schema.define(version: 2021_05_25_092714) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["order_history_id"], name: "index_buyers_on_order_history_id"
  end
  ...
  add_foreign_key "buyers", "order_histories"
